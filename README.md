About streamlit-keyup-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/streamlit-keyup-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/streamlit-keyup-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add streamlit-keyup
# for installing globally
pixi global install streamlit-keyup
```
...
It is possible to list all of the versions of `streamlit-keyup` available on your platform:
...
```
pixi search streamlit-keyup --channel conda-forge
```
